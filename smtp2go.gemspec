...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["jezman"]
  spec.email         = ["dev.jezman@gmail.com"]

  spec.summary       = %q{SMTP2GO short summary, because RubyGems requires one.}
  spec.description   = %q{SMTP2GO longer description or delete this line.}
  spec.homepage      = "https://github.com/jezman/smtp2go"
